...
def get_env_config():
    ...
    return {
        ...
        "llm_api_keys": {
            "1": os.getenv("GPTBOTS_LLM_API_KEY_1", "app-OelZGmC6OrlA5EB2SG3Frglh"),
        ...
        "kb_api_keys": {
            "1": os.getenv("GPTBOTS_KB_API_KEY_1", "app-r1xQfYiIA6YwHjfIBj9ahmCZ"),
        ...
        # 问答系统API Keys (支持多个编号)
        "qa_api_keys": {
            "1": os.getenv("GPTBOTS_QA_API_KEY_1", "app-AYGRiA6TP12EeP1A0FgoRc6O"),
